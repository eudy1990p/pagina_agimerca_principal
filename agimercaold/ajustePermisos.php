<?php
	...
	$permitir = $usuario->validarEntradaIlegal($_SESSION["permisos"],"permiso");
	$paso2 = false;
	if (isset($_POST)) {
...
?>
<script >
	$("html").ready(function () { ActivarEnlaceMenu("idMenuAjuste","active dropdown","<?php echo $label->MenuAjustePermiso; ?>"); });
</script>
...
<div class="page-header">
	        <h1><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> 
                  <?php echo $label->MenuAjustePermiso; ?></h1>
</div>
...
<div role="tabpanel">
  ...
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane <?php if (!$paso2) { ?> active <?php } ?>" id="home">
    	...
    	<div class="page-header">
	        <h3><?php echo $label->Paso; ?> 1 <?php echo $label->De; ?> 2<small> <?php echo $label->SeleccionDel; ?> <?php echo $label->MinusculaGrupo; ?></small></h3>
	    </div>
    ...
    <div role="tabpanel" class="tab-pane <?php if ($paso2) { ?> active <?php } ?>" id="profile">
    	...
    	?>
    	<div class="page-header">
	        <h3><?php echo $label->Paso; ?> 2 <?php echo $label->De; ?> 2<small> <?php echo $label->Editar; ?> <?php echo $label->MinusculaPermiso; ?></small></h3>
	    </div>

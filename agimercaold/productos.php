<?php
	...
	if(isset($_POST)){
		if(isset($_POST["accion"]) && ($_POST["accion"] == "categoria")){
			$categoria->addProducto($_POST);
		}
		if(isset($_POST["accion"]) && ($_POST["accion"] == "editar_categoria")){
			$categoria->editProducto($_POST);
		}
		if( isset($_GET["id"]) ){
			$categoria->deleteProducto($_GET);
		}
	}
?>
...
<div class="page-header">
	        <h1><span class="glyphicon glyphicon-file" aria-hidden="true"></span> 
                  <?php echo "Producto (Sub Sub categoria)"; ?></h1>
</div>
		...
		<div class="col-xs-8">
			<form action="" method="post" enctype="multipart/form-data">
			 ...
			 <input type="hidden" name="idCategoria" id="idCategoria" value=""/>
				...
				<div class="row">
					...
					<div class="col-xs-12">
						Producto (Sub Sub categoria)<br/>
						<input type="text" id="categoria" name="categoria" placeholder="Nombre del producto" class="form-control" >
					</div>
			...
			<div class="row">
					...
					<div class="col-xs-12"><br/>
							<?php require_once("vista_tabla_producto.php"); ?>
					</div>
			</div>

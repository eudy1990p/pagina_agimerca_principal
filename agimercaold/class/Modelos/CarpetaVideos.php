	...
	*/
	class CarpetaVideos
	{
		...
		public static function getCarpetaGalerias($id,$datos){
			...
			$sql = "SELECT * from carpeta_videos where user_id_creado = $user->id";
		...
		public static function guardar($datos){
			...
			$sql =
			"INSERT into carpeta_videos values ".
		...
		public static function desactivar($id){
			...
			$sql ="UPDATE carpeta_videos set estado = 'desactivado' where id=".$id;
		...
		public static function getUltimo(){
			...
			$sql = "select max(id) as ultimo from carpeta_videos";

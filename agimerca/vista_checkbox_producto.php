<?php 
		...
		$result1 = $categoria->getProducto();
		
		$selectArray= array();
		while($resC = mysqli_fetch_object($resultSelectCategoriaSubCategorio)){
			$selectArray[] = $resC->sub_sub_categoria_name;
		}
...
<form action="" method="post">
	<div class="panel panel-default">
		<div class="panel-heading">Seleccionar producto (Sub Sub Categoria)</div>
		<div class="panel-body">

					 <input type="hidden" name="realizar" value="agregar_relacion_sub_sub_categoria" />
					 ...
					 <input type="hidden" name="idcategoria" value="<?php echo $_GET["idcategoria"]; ?>" />
						...
						?>
									<label>
										<input type="checkbox" name="producto[]" value="<?php echo $resCategoria->id; ?>"> <?php echo $resCategoria->nombre_categoria; ?>
									</label>
